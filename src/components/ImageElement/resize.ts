...
export function resizeIn(size: Size, bounds: Bounds) {
...
export const resizeInWidth = (size: Size, width: number) => resizeIn(size, { width, height: BIG_DIMENSION });
export const resizeInHeight = (size: Size, height: number) => resizeIn(size, { width: BIG_DIMENSION, height });
