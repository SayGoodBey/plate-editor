  ...
  children: [
    {
      ...
      className: 'qt_default',
      type: 'p',
      children: [
        {
          text: '2020-2021学年江西省南昌市红谷滩区凤凰城上海外国语学校七年级(下)期末数学复习试卷(2)',
        },
      ],
    },
    {
...
export default () => {
  ...
  const [initialValue, setInitialValue] = useState('<p>123</p><p></p>');
  // <p  ><span  style="color:#232323;">发撒发生粉撒地方</span></p>
  ...
  const handleChangeInitial = () => {
    setInitialValue('22323233');
    setResetInitialValue((v) => v + 1);
  };
