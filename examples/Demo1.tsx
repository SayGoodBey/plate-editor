...
export default () => {
  ...
  const [initialValue, setInitialValue] = useState(
    '<img src="https://wsevlf001.eeo.im/upload/files/file01/20230912/00_06_7b1db11-2403-43e6-a754-101ea5a45c7.png" alt="alt哈哈" width="50" height="50" /><p style="color:red"><span style="color:blue">aaaa</span></p><p class="c1 c2">测试删除替换</p><p id="jack">我是要被替换的元素</p>',
  );
